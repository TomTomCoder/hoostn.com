...
import type { FormStep } from '@/lib/stores/lotFormStore';
...
const steps = [
  { number: 1, title: 'Basic Info', description: 'Lot details' },
  { number: 2, title: 'Amenities & Pricing', description: 'Features & rates' },
  { number: 3, title: 'Images & Availability', description: 'Photos & calendar' },
] as const;
